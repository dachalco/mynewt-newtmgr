...
2. Rename resulting `apache-mynewt-newtmgr-1.9.0` directory to `$GOPATH/src/github.com/dachalco/mynewt-newtmgr`
3. `cd $GOPATH/src/github.com/dachalco/mynewt-newtmgr/newtmgr`
